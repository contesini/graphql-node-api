...
import { db, app, chai, handleError, mocha, expect } from "../../test-utils";
    ...
    describe('Queries', () => {
        ...
        describe('application/json', () => {
                ...
                it('should return a list of Posts', () => {
                    ...
                    return chai.request(app)
                        ...
                        .then(res => {
                            ...
                            expect(postsList[0]).to.not.have.keys(['id', 'created', 'updatedAt', 'author', 'comments']);
            ...
            describe('post', () => {
                ...
                it('should return a single Post with you author', () => {
                    ...
                    return chai.request(app)
                        ...
                        .then(res => {
                            ...
                            expect(singlePost).to.be.an('object').with.not.keys(['id', 'createdAt', 'updatedAt', 'posts']);
                        }).catch(handleError)
                });
            });
        });
            ...
            it('should paginate a list of Posts', () => {
                ...
                return chai.request(app)
                    ...
                    .then(res => {
                        const postsList = res.body.data.posts;
                        expect(res.body.data).to.be.an('object')
                        expect(postsList).to.be.an('array').length(2);
                        expect(postsList[0]).to.not.have.keys(['id', 'created', 'updatedAt', 'author', 'comments']);
                        expect(postsList[0]).to.have.keys(['title', 'content', 'photo']);
