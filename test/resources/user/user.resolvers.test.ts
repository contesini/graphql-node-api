                ...
                it('should return a list of Users', () => {
                    ...
                    return chai.request(app)
                        ...
                        .then((res) => {
                            ...
                            expect(usersList[0]).to.not.have.keys(['id', 'photo', 'updatedAt', 'post', 'createdAt']);
                ...
                it('should paginate a list of Users', () => {
                    ...
                    return chai.request(app)
                        ...
                        .then((res) => {
                            ...
                            expect(usersList[0]).to.not.have.keys(['id', 'photo', 'updatedAt', 'post']);
            ...
            describe('user', () => {
                ...
                it('should return only \'name\' attribute', () => {
                    ...
                    return chai.request(app)
                        ...
                        .send(JSON.stringify(body))
                        .then((res) => {
                            const user: UserInstance = res.body.data.user;
                            expect(res.body.data).to.be.an('object');
                            expect(user).to.be.an('object');
    ...
    describe('Mutations', () => {
        ...
        describe('application/json', () => {
            ...
            it('should update an existing User', () => {
                ...
                let body = {
                    query: `
                            mutation createNewUser($input: UserUpdateInput!) {
